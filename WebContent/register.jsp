...
<div id="wrap">
        ...
        <div id="menu">
            <ul>
               ...
               <c:if test="${sessionScope.u_account==null}" var="check">
	                ...
	                <li class="log-reg selected"><a href="register.jsp">注册</a></li>
                </c:if>
                <c:if test="${sessionScope.u_account!=null}" var="check">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <p class="details" id="register-tag">
                请正确填写格式规范
            </p>
            
              	<div class="contact_form">
                <div class="form_subtitle">创建你的用户</div>
                 <form name="register" action="register">          
                    <div class="form_row">
	                    <label class="contact"><strong>账号:</strong></label>
	                    <input type="text" class="contact_input" id="u-account" placeholder="请输入八位字符或数字"/>
	                    <div class="account" style="display: none;margin-left: 50px;color: red">请使用八位数字或者字母注册账号</div>
	                    <div class="user_error" style="display: none;margin-left: 50px;color: red">用户名重复，请重新创建一个账号</div>
                    </div>

                     <div class="form_row">
                         <label class="contact"><strong>用户名:</strong></label>
                         <input type="text" class="contact_input" id="u_name" placeholder="请输入你的昵称"/>
                     </div>

                     <div class="form_row">
	                    <label class="contact"><strong>密码:</strong></label> 
	                    <input type="password" class="contact_input"  id="u_password" placeholder="请输入密码"/>
                    </div> 
                    
                    <div class="form_row">
	                    <label class="contact"><strong>确认密码:</strong></label>
	                    <input type="password" class="contact_input" id="checkPass" placeholder="再次确认密码"/>
	                    <div class="password" style="display: none;margin-left: 50px;color: red">两次输入的密码不一致</div>
                    </div> 

                    <div class="form_row">
	                    <label class="contact"><strong>电子邮件:</strong></label>
	                    <input type="text" class="contact_input" id="u_email" placeholder="输入正确格式的密码"/>
	                    <div class="email" style="display: none;margin-left: 50px;color: red">请输入正确格式的邮件</div>
                    </div>


                    <div class="form_row">
                    <label class="contact"><strong>电话:</strong></label>
                    <input type="text" class="contact_input" id="u_phone" placeholder="请输入正确的手机号码"/>
                    <div class="phone" style="display: none;margin-left: 50px;color: red">请输入正确的手机号码</div>
                    </div>
                    

                    <div class="form_row">
                        <div class="terms">
                        <input type="checkbox" name="terms" id="proto"/>
                        	我同意 <a href="#">《叮当购》协议</a>                        </div>
                    </div> 

                    
                    <div class="form_row">
                    	<input type="button" class="register" id="btn" value="register"/>
                    </div>   
                  </form>     
                </div>  
